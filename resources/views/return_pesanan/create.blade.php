<x-app-layout title="Tambah Barang Retur - Alur Confused" icon='<i data-lucide="package-plus" class="me-3"></i> Tambah Barang Retur'>
    <div class="container-fluid">
        <!-- Header -->
        <div class="row mb-4">
            <div class="col-md-6">
                <h4 class="mb-0" style="color: var(--color-foreground); font-weight: 600;">Tambah Barang Retur</h4>
                <p class="text-muted mb-0" style="font-size: 14px;">Tambah data barang retur baru</p>
            </div>
            <div class="col-md-6 text-end">
                <a href="{{ route('return_pesanan.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="card border-0 shadow-sm" style="background: var(--color-background); border-radius: 16px;">
            <div class="card-body" style="padding: 2rem;">
                <form id="returnPesananForm" action="{{ route('return_pesanan.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-floating mb-3">
                                <input type="date" 
                                       ...
                                       id="tanggal_return" 
                                       name="tanggal_return" 
                                       value="{{ old('tanggal_return', date('Y-m-d')) }}"
                                       required>
                            ...
                            <div class="form-floating mb-3">
                                <select
                                    class="form-select minimal-input"
                                    name="toko"
                                    required
                                >
                                    ...
                                    <option value="manmayer">Manmayer</option>
                                    <option value="simplejoy">Simplejoy</option>
                                </select>
...
function updateQty(index, value) {
    selectedBarang[index].qty = value;

    // refresh tabel biar total per item & grand total update
    updateTableDisplay();
}
