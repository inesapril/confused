<x-app-layout title="Edit Toko - Alur Confused" icon='<i data-lucide="package-plus" class="me-3"></i> Edit Toko'>
    <div class="container-fluid">
        <!-- Header -->
        <div class="row mb-4">
            <div class="col-md-6">
                <h4 class="mb-0" style="color: var(--color-foreground); font-weight: 600;">Edit Toko</h4>
                <p class="text-muted mb-0" style="font-size: 14px;">Edit data toko baru</p>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm" style="background: var(--color-background); border-radius: 16px;">
            <div class="card-body" style="padding: 2rem;">
                <form id="tokoForm" action="{{ route('toko.update', $toko->id) }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input
                                    ...
                                    id="platform"
                                    name="platform"
                                    value="{{ old('platform', $toko->platform) }}"
                                    placeholder=""
                                >
...
let selectedBarang = {!! json_encode(
    $toko->barangs->map(function($barang) {
        return [
            'id' => $barang->id,
