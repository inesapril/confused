<x-app-layout title="Tambah Stok Opname - Alur Confused" icon='<i data-lucide="refresh-cw" class="me-3"></i> Tambah Stok Opname'>
    <div class="container-fluid">
        <!-- Header -->
        <div class="row mb-4">
            <div class="col-md-6">
                <h4 class="mb-0" style="color: var(--color-foreground); font-weight: 600;">Tambah Penyesuaian Persediaan</h4>
                <p class="text-muted mb-0" style="font-size: 14px;">Tambah data stok opname baru</p>
            </div>
                    ...
                    row.innerHTML = `
                        ...
                        <td>
                            <span class="badge bg-secondary"
                                id="selisih${index}">
                                ${(barang.stokFisik ?? barang.stokSistem) - barang.stokSistem}
                            </span>
                        </td>
                        <td>
                            <button type="button"
