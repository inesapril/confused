<x-app-layout title="Edit Supplier - Alur Confused" icon='<i data-lucide="package-plus" class="me-3"></i> Edit Supplier'>
    <div class="container-fluid">
        <!-- Header -->
        <div class="row mb-4">
            <div class="col-md-6">
                <h4 class="mb-0" style="color: var(--color-foreground); font-weight: 600;">Edit Supplier</h4>
                <p class="text-muted mb-0" style="font-size: 14px;">Edit data supplier baru</p>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm" style="background: var(--color-background); border-radius: 16px;">
            <div class="card-body" style="padding: 2rem;">
                <form id="supplierForm" action="{{ route('supplier.update', $supplier->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input
                                    type="text"
                                    class="form-control minimal-input @error('supplier') is-invalid @enderror"
                                    id="nama_supplier"
                                    name="nama_supplier"
                                ...
                                <table class="table table-striped table-hover align-middle" id="barangTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-weight: 600; color: var(--color-foreground);">Harga Supplier</th>
...
<div class="d-flex justify-content-end gap-3 mt-5">
    <a href="{{ route('supplier.index') }}" class="btn btn-light minimal-btn-secondary">
        <p class="d-flex align-items-center mb-0">
...
let selectedBarang = {!! json_encode(
    $supplier->barangs->map(function($barang) {
        return [
            'id' => $barang->id,
