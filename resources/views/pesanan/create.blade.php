<x-app-layout title="Tambah Pesanan - Alur Confused" icon='<i data-lucide="package-plus" class="me-3"></i> Tambah Pesanan'>
    <div class="container-fluid">
        <!-- Header -->
        <div class="row mb-4">
            <div class="col-md-6">
                <h4 class="mb-0" style="color: var(--color-foreground); font-weight: 600;">Tambah Pesanan</h4>
                <p class="text-muted mb-0" style="font-size: 14px;">Tambah data pesanan baru</p>
            </div>
        </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control minimal-input" id="no_pesanan" 
                                       value="{{ $noPesanan }}" readonly>
                            ...
                            <div class="form-floating mb-3">
                                <select
                                    class="form-select minimal-input @error('toko_id') is-invalid @enderror"
                                    id="toko_id"
                                    name="toko_id"
                                    required
                                >
...
<div class="modal fade" id="addBarangModal" tabindex="-1" aria-labelledby="addBarangModalLabel" aria-hidden="true">
    ...
    // Kalau toko diganti
    document.getElementById('toko_id')
