<x-app-layout title="Tambah Supplier - Alur Confused" icon='<i data-lucide="package-plus" class="me-3"></i> Tambah Supplier'>
    <div class="container-fluid">
        <!-- Header -->
        <div class="row mb-4">
            <div class="col-md-6">
                <h4 class="mb-0" style="color: var(--color-foreground); font-weight: 600;">Tambah Supplier</h4>
                <p class="text-muted mb-0" style="font-size: 14px;">Tambah data supplier baru</p>
            </div>
