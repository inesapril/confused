<x-app-layout title="Edit Reseller - Alur Confused" icon='<i data-lucide="package-plus" class="me-3"></i> Edit Reseller'>
    <div class="container-fluid">
        <!-- Header -->
        <div class="row mb-4">
            <div class="col-md-6">
                <h4 class="mb-0" style="color: var(--color-foreground); font-weight: 600;">Edit Reseller</h4>
                <p class="text-muted mb-0" style="font-size: 14px;">Edit data reseller baru</p>
            </div>
            <div class="col-md-6 text-end">
                <a href="{{ route('reseller.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="card border-0 shadow-sm" style="background: var(--color-background); border-radius: 16px;">
            <div class="card-body" style="padding: 2rem;">
                <form id="resellerForm" action="{{ route('reseller.update', $reseller->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input
                                    type="text"
                                    class="form-control minimal-input @error('reseller') is-invalid @enderror"
                                    id="nama_reseller"
                                    name="nama_reseller"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input
                                    type="text"
                                    class="form-control minimal-input @error('alamat') is-invalid @enderror"
                                    id="alamat"
                                    name="alamat"
                                    value="{{ old('alamat', $reseller->alamat) }}"
                                    placeholder=""
                                >
                                ...
                                <table class="table table-striped table-hover align-middle" id="barangTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="font-weight: 600; color: var(--color-foreground);">Harga Reseller</th>
...
<div class="d-flex justify-content-end gap-3 mt-5">
    <a href="{{ route('reseller.index') }}" class="btn btn-light minimal-btn-secondary">
        <p class="d-flex align-items-center mb-0">
    ...
    <button 
        ...
        class="btn btn-primary minimal-btn-primary">
            <p class="d-flex align-items-center mb-0">
                <i data-lucide="save" style="margin-right: 8px; width: 20px; height: 20px;"></i> Simpan Reseller
            </p>
    </button>
</div>
...
let selectedBarang = {!! json_encode(
    $reseller->barangs->map(function($barang) {
        return [
            'id' => $barang->id,
