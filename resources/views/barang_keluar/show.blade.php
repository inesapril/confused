<x-app-layout title="Detail Barang Keluar - Alur Confused" icon='<i data-lucide="eye" class="me-3"></i> Detail Penyesuaian'>
    <div class="container-fluid">
        <!-- Header -->
        <div class="row mb-4">
            <div class="col-md-6">
                <h4 class="mb-0" style="color: var(--color-foreground); font-weight: 600;">Detail Barang Keluar</h4>
                <p class="text-muted mb-0" style="font-size: 14px;">{{ $barangKeluar->no_barang_keluar }}</p>
            </div>
            <div class="col-md-6 text-end">
                <a href="{{ route('barang_keluar.index') }}" class="btn btn-outline-secondary me-2">
                    <p class="d-flex align-items-center mb-0">
                        <i data-lucide="arrow-left" style="margin-right: 8px; width: 20px; height: 20px;"></i> Kembali
                    </p>
                </a>
                <a href="{{ route('barang_keluar.edit', $barangKeluar->id) }}" class="btn btn-warning">
                    <p class="d-flex align-items-center mb-0">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <strong style="color: var(--color-foreground);">
                                {{ $barangKeluar->tanggal_keluar->format('d F Y') }}
                            </strong>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <strong style="color: var(--color-foreground);">
                                {{ $barangKeluar->reseller->nama_reseller }}
                            </strong>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <span class="badge bg-info">
                                {{ $barangKeluar->details->sum('qty') }} pcs
                            </span>
                        </div>
                                ...
                                <tfoot>
                                    <tr style="background-color: rgba(74, 200, 234, 0.08);">
                                        ...
                                        <td class="fw-bold text-center" style="padding:16px;">
                                            Rp {{ number_format($barangKeluar->total, 0, ',', '.') }}
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
