<x-app-layout title="Tambah Barang Keluar - Alur Confused" icon='<i data-lucide="package-plus" class="me-3"></i> Tambah Barang Keluar'>
    <div class="container-fluid">
        <!-- Header -->
        <div class="row mb-4">
            <div class="col-md-6">
                <h4 class="mb-0" style="color: var(--color-foreground); font-weight: 600;">Tambah Barang Keluar</h4>
                <p class="text-muted mb-0" style="font-size: 14px;">Tambah data barang keluar baru</p>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm" style="background: var(--color-background); border-radius: 16px;">
            <div class="card-body" style="padding: 2rem;">
                <form id="barangKeluarForm" action="{{ route('barang_keluar.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-floating mb-3">
                                <select
                                    class="form-select minimal-input @error('reseller_id') is-invalid @enderror"
                                    id="reseller_id"
                                    name="reseller_id"
                                    required
                                >
        ...
        <!-- Submit Buttons -->
            <div class="d-flex justify-content-end gap-3 mt-5">
                ...
                <button
                    ...
                    <p class="d-flex align-items-center mb-0">
                        <i data-lucide="save" style="margin-right: 8px; width: 20px; height: 20px;"></i> Simpan Barang Keluar
                    </p>
                </button>
            </div>  
    </div>
...
<div class="modal fade" id="addBarangModal" tabindex="-1" aria-labelledby="addBarangModalLabel" aria-hidden="true">
    ...
    document.getElementById('reseller_id')
...
function updateStock(index, value) {
    ...
    if (jumlahCell) {
        jumlahCell.innerText =
            'Rp ' + (
                (Number(value) || 0) *
                Number(selectedBarang[index].harga)
            ).toLocaleString('id-ID');
    }
}
