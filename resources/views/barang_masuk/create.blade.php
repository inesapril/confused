<x-app-layout title="Tambah Barang Masuk - Alur Confused" icon='<i data-lucide="package-plus" class="me-3"></i> Tambah Barang Masuk'>
    <div class="container-fluid">
        <!-- Header -->
        <div class="row mb-4">
            <div class="col-md-6">
                <h4 class="mb-0" style="color: var(--color-foreground); font-weight: 600;">Tambah Barang Masuk</h4>
                <p class="text-muted mb-0" style="font-size: 14px;">Tambah data barang masuk baru</p>
            </div>
        </div>
                ...
                <form id="barangMasukForm" action="{{ route('barang_masuk.store') }}" method="POST">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-floating mb-3">
                                <select
                                    class="form-select minimal-input @error('supplier_id') is-invalid @enderror"
                                    id="supplier_id"
                                    name="supplier_id"
                                    required
                                >
        ...
        <!-- Submit Buttons -->
            <div class="d-flex justify-content-end gap-3 mt-5">
                ...
                <button
                    ...
                    <p class="d-flex align-items-center mb-0">
                        <i data-lucide="save" style="margin-right: 8px; width: 20px; height: 20px;"></i> Simpan Barang Masuk
                    </p>
                </button>
            </div>  
    </div>
