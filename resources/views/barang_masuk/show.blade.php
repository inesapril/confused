<x-app-layout title="Detail Barang Masuk - Alur Confused" icon='<i data-lucide="eye" class="me-3"></i> Detail Penyesuaian'>
    <div class="container-fluid">
        <!-- Header -->
        <div class="row mb-4">
            <div class="col-md-6">
                <h4 class="mb-0" style="color: var(--color-foreground); font-weight: 600;">Detail Barang Masuk</h4>
                <p class="text-muted mb-0" style="font-size: 14px;">{{ $barangMasuk->no_barang_masuk }}</p>
            </div>
            <div class="col-md-6 text-end">
                ...
                <a href="{{ route('barang_masuk.edit', $barangMasuk->id) }}" class="btn btn-warning">
                    <p class="d-flex align-items-center mb-0">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <strong style="color: var(--color-foreground);">
                                {{ $barangMasuk->tanggal_masuk->format('d F Y') }}
                            </strong>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <span class="badge bg-info">
                                {{ $barangMasuk->details->sum('qty') }} pcs
                            </span>
                        </div>
                            ...
                            <table class="table table-striped table-hover align-middle">
                                <thead>
                                    <tr style="background-color: rgba(74, 200, 234, 0.1);">
                                        ...
                                        <th style="border:none; padding:16px; text-align:center;">Stok Masuk</th>
